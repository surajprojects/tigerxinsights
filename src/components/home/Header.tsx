...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`w-full font-sans font-medium fixed top-0 left-0 z-50 bg-white/30 backdrop-blur-sm ${isScrolled ? "border-b border-white/20 shadow-sm" : "border-none shadow-none"}`}
      >
