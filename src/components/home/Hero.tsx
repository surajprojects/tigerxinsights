        ...
        <>
            <div className="text-center flex flex-col items-center p-2">
                ...
                <div className="block sm:flex my-10">
                    <a href="#" className="text-white text-sm font-medium flex justify-center items-center px-8 py-3 rounded-xl mx-2 duration-300 ease-in-out hover:cursor-pointer hover:brightness-95 bg-linear-to-r from-[#7c3bed] to-[#3c83f6] shadow-md mb-6 sm:mb-0">View My Work</a>
                    <a href="#" className="text-black text-sm font-medium flex justify-center items-center px-8 py-3 rounded-xl mx-2 duration-300 ease-in-out hover:cursor-pointer bg-white border border-gray-300 hover:bg-[#3c83f6] hover:text-white hover:shadow-md">Get In Touch</a>
                </div>
                <SocialHandles />
                <a href="#" className="my-6 sm:my-10 hover:cursor-pointer ">
                    <ArrowDown />
                </a>
            </div>
        </>
